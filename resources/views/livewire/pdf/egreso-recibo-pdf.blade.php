...
<head>
    <meta charset="UTF-8">
    <title>Comprobante de Egreso - {{ $datosRecibo['nro_recibo'] }}</title>
    <style>
        ...
        /* Firmas */
        .firmas-table { width: 100%; margin-top: 40px; margin-bottom: 20px;}
        .firma-linea { border-top: 2px dashed #222; padding-top: 5px; margin: 0 20px; }
        .firma-texto { font-weight: bold; font-size: 11px; text-transform: uppercase; color: #000; margin-bottom: 2px;}
        .firma-sub { font-size: 10px; color: #666; }
    </style>
</head>
<body>
    ...
    <table class="comprobante-header">
        <tr>
            <td class="text-left"><h2 class="comprobante-title">Comprobante de Egreso</h2></td>
        ...
        <table>
            <tr>
                <td width="50%" valign="top">
                    <span class="info-label">Beneficiario / Proveedor:</span><br>
                    <span class="info-data" style="font-size: 13px;">{{ $datosRecibo['proveedor'] }}</span><br>
                    <span class="info-label">Método de Pago:</span> <span style="font-size: 11px; font-weight: normal;">{{ $datosRecibo['metodo_pago'] }}</span>
                </td>
                <td width="50%" class="text-right" valign="top">
                    ...
                    <span class="info-label">Cajero Responsable:</span> <span style="font-size: 12px; font-weight: normal;">{{ $datosRecibo['cajero'] }}</span>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div class="concepto-box">
        <div class="concepto-title">Concepto del Gasto</div>
        ...
        <tr>
            <td width="50%" class="text-center">
                <div class="firma-linea">
                    <div class="firma-texto">Entregué Conforme</div>
                    <div class="firma-sub">{{ $datosRecibo['cajero'] }}</div>
                </div>
            </td>
            <td width="50%" class="text-center">
                <div class="firma-linea">
                    <div class="firma-texto">Recibí Conforme</div>
                    <div class="firma-sub">Firma Beneficiario / CI</div>
                </div>
            </td>
        </tr>
    </table>
